...
discountd_plot = ggplot(data=discount_d) + 
  geom_histogram(aes(x = discount1.5_output), binwidth =200, color = "black", fill = "blue") + labs(x = "Social Cost Of Carbon", y = "Frequency", title = "Social Cost Of Carbon (1.5%)") + theme_classic()
