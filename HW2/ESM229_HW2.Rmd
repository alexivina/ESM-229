...
output_1.5 = for(i in 1:250){
  ...
  discount1.5_output[i] = toy_IAM_SCC(p_damage, p_climSens_output[i], p_discount1.5)
  
}

mean(discount1.5_output) # = 299.26
median(discount1.5_output) # = 251.5304
sd(discount1.5_output) # = 193.2659

```

3.0% Discount
```{r}
output_3.0 = for(i in 1:250){
  p_climSens_output[i] = rlnorm(1, meanlog=0.95, sdlog=0.53)
  
  discount3.0_output[i] = toy_IAM_SCC(p_damage, p_climSens_output[i], p_discount3.0)
  
}

mean(discount3.0_output) # = 38.15951
median(discount3.0_output) # = 30.90275
sd(discount3.0_output) # = 1.554641
```
...
output_3.0 = for(i in 1:250){
  ...
  discount5.0_output[i] = toy_IAM_SCC(p_damage, p_climSens_output[i], p_discount3.0)
  
}

mean(discount5.0_output) # = 10.0039
median(discount5.0_output) # = 6.92559
sd(discount5.0_output) # = 9.729807
