...
output_1.5 = for(i in 1:250){
  ...
  discount1.5_output[i] = toy_IAM_SCC(p_damage, p_climSens_output[i], 0.015)
...
for(i in 1:250){
  ...
  discount1.5_output[i] = toy_IAM_SCC(p_damage_output[i], p_climSens, 0.015)
  
}
#1.5%
mean(discount1.5_output) # = 66.50177
median(discount1.5_output) # = 323.7824
sd(discount1.5_output) # = 958.1419
```
...
toy_IAM_optimal(p_abatePct, p_abate, p_damage, p_climSens, p_discount)
