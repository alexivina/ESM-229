...
plus_one_ton = c((1/10^6), rep(0, 290)) #plus one ton of CO2
...
em_ppm[j]<-(em_MtCO2[j]+plus_one_ton)/7810 # convert to atmospheric CO2 concentrations
...
```{r}
write.csv(climateDamage,"C:\\Users\\blsju\\Desktop\\BREN\\Second Year\\Winter Quarter\\ESM 229\\climateDamageSim1.csv", row.names = FALSE)
```

```{r}
climateDamage_BAU <- read.csv(file = 'climateDamageBAU.csv')
